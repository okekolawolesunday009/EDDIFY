...
'numbers, dots or underscores')])
    ...
    first_name = StringField("first name", validators=[DataRequired(), Length(min=2, max=20), Regexp('^[A-Za-z][A-Za-z0-9_.]*$', 0,
'First name must have only letters,')])
    last_name = StringField("last name", validators=[DataRequired(), Length(min=2, max=20), Regexp('^[A-Za-z][A-Za-z0-9_.]*$', 0,
'First name must have only letters,')])
    country_choices = [
    ('', 'Select Country'),
    ('af', 'Afghanistan'),
